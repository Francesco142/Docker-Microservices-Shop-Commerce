...
public class BuyerController {
    ...
    public ResponseEntity<?> test() {
        String stockerEndpoint = "http://container-stocker:8083/api/stocker-service/test";
        HttpHeaders headers = new HttpHeaders();
        headers.setContentType(MediaType.APPLICATION_JSON);

        return restTemplate.exchange(stockerEndpoint, HttpMethod.GET, null, String.class);
    }
	...
	public ResponseEntity<?> order(@RequestBody BuyerDTO buyerDTO) {
		...
		String stockerEndpoint = "http://container-stocker:8083/api/stocker-service/checkOrder";
